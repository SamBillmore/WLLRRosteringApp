...
class ErrorScreen(Frame, ResourcePath):
    ...
    def __init__(self, parent, controller, background_col, foreground_col, font):
        ...
        self.intro_label = Label(
            self,
            text="There has been an error with one of the files imported.",
            bg=background_col,
            fg=foreground_col,
            font=font,
        )
        self.filepath_label = Label(
            self,
            text="The file with errors is: ",
            bg=background_col,
            fg=foreground_col,
            font=font,
        )
        self.expected_columns_label = Label(
            self,
            text="The expected columns are: ",
            bg=background_col,
            fg=foreground_col,
            font=font,
        )
        self.error_filepath_label = Label(
            self, text="", bg=background_col, fg=foreground_col, font=font
        )
        self.error_expected_columns_label = Label(
            self, text="", bg=background_col, fg=foreground_col, font=font
        )
        ...
        self.error_expected_columns_label.grid(
            row=3, column=1, sticky="W", padx=25, pady=0
        )
...
class ErrorScreenExport(Frame, ResourcePath):
    ...
    def __init__(self, parent, controller, background_col, foreground_col, font):
        ...
        self.intro_label = Label(
            self,
            text="There has been an error with the creation of your file.",
            bg=background_col,
            fg=foreground_col,
            font=font,
        )
        self.error_message_label = Label(
            self,
            text="Please ensure you do not have the file open, then try again.",
            bg=background_col,
            fg=foreground_col,
            font=font,
        )
